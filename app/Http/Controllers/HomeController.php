...
class HomeController extends Controller
{
    ...
    public function storeCareer(Request $request){
        ...
        if($result){
           try {
                ...
                $subject2 = 'Welcome to Paisapocket';
    ...
    public function testdata(){
       ...
       $mailData = array(
        ...
        /* send email in brevo */
        $res = sendBrevoHtmlMail2($mailData, 'Congratulations! Payment Successful for Paisapocket’s Self-Apply Plan.', $sendGreetings, 3, $attachments);
